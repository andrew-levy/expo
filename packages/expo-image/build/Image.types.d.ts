...
export interface ImageProps extends ViewProps {
    ...
    /**
     * An [SF Symbol](https://developer.apple.com/design/human-interface-guidelines/foundations/sf-symbols) icon to display. Specifying this prop will override the `source` prop.
     * @platform ios
     */
    sfSymbol?: SFSymbol | null;
    /**
